...
class TestFinVizSpider:
    ...
    def test_spider_initialization_with_existing_articles(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', delete=False, suffix='.csv') as tickers_file:
            ...
            with tempfile.NamedTemporaryFile(mode='w', delete=False, suffix='.jsonl') as articles_file:
                articles_file.write('{"url": "https://example.com/existing", "title": "Existing"}\n')
                articles_file.flush()
    ...
    def test_parse_main_with_articles(self):
        ...
        # Mock article blocks
        article1 = MagicMock()
        article1.css.return_value.get.side_effect = ['Test Title 1', 'https://finviz.com/news1', 'Source 1']
    ...
    def test_parse_main_skip_duplicates(self):
        ...
        # Mock article blocks
        article = MagicMock()
        article.css.return_value.get.side_effect = ['Test Title', 'https://finviz.com/duplicate', 'Source']
